...
echo ""
echo -e "1. ${BOLD}CLI Agents:${NC} The default config uses placeholders like 'gemini-cli'."
echo -e "   You MUST install these tools or edit ${YELLOW}.orkestra/config.yaml${NC} to use your own."
echo -e "   Ensure the commands are available in your PATH."
echo ""
